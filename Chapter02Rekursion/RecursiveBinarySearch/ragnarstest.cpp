...
bool ragnarsFloatTest(){
    ...
    if (ok)
        std::cerr << "ragnarsFloatTest lyckades pa " << eclapsed << " millisekunder\n";
...
void testComplexity(){
    ...
    cout << "Vi kommer nu att soka efter " << size << " existerande och " << size << " ickeexisterande tal i en array bestaende av " << size << " tal...\n";
    ...
    cout << "Tidsmatning: "<< elapsed << " millisekunder\n";
...
bool ragnarsTest1(){
    ...
    cout << "Nar testen ar klar kommer jag att skriva att testen har lyckats,\n"
    ...
    if (isDebugmode())
        cout << "testen lyckades troligtvis, men kor aven i RELEASE-mode!! \7\n";
